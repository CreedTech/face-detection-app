...
class ShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double yc2 = yc+radius*2*cos(radians);
    Offset center2 = Offset(xc2, yc2);
    Paint paint = Paint()
    ...
    canvas.drawCircle(center2, radius+2, paint3);
    canvas.drawCircle(center2, radius, paint);
    final double xp = radius*cos(radians*3)+xc2;
    final double yp = yc2+radius*sin(radians*3);
    canvas.drawCircle(center2, 5, paint2);
    canvas.drawLine(center2, Offset(xp,yp), paint2);
